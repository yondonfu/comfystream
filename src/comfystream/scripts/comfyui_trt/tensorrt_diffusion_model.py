...
from comfyui_trt.models import get_model_from_version, TRTModelUtil
...
class TQDMProgressMonitor(trt.IProgressMonitor):
    ...
    def step_complete(self, phase_name, step):
        try:
            ...
            # There is no need to propagate this exception to comfyui_trt. We can simply cancel the build.
            return False
