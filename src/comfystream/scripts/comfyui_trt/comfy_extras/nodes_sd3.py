import comfyui_trt.folder_paths
import comfy.sd
import comfy.model_management
import comfyui_trt.nodes
import torch
import comfyui_trt.comfy_extras.nodes_slg
...
class ControlNetApplySD3(comfyui_trt.nodes.ControlNetApplyAdvanced):
    @classmethod
    def INPUT_TYPES(s):
...
class SkipLayerGuidanceSD3(comfyui_trt.comfy_extras.nodes_slg.SkipLayerGuidanceDiT):
    '''
