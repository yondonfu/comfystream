...
def patch_controlnet_for_stream():
    """Patch ControlNet for better compatibility with StreamDiffusion and torch.compile()"""
    try:
        ...
        print("Successfully patched ControlNet for StreamDiffusion compatibility")
