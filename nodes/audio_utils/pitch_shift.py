...
class PitchShifter:
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                "audio": ("AUDIO",),
                "pitch_shift": ("FLOAT", {"default": 4.0, "min": 0.0, "max": 12.0, "step": 0.5}),
            }
        }
    ...
    def execute(self, audio, pitch_shift):
        ...
        shifted_audio = librosa.effects.pitch_shift(
            y=audio_numpy, sr=sample_rate, n_steps=pitch_shift
        )
        ...
        # Return AUDIO format
        result_audio = {"waveform": shifted_tensor, "sample_rate": sample_rate}
